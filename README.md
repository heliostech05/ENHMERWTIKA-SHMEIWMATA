...
Η συνολική ροή ξεκινά από την πιστοποιημένη ανάκτηση παραγωγής και τιμών αγοράς, προχωρά στην κανονικοποίηση και εναρμόνιση των δεδομένων, συνεχίζει με τον υπολογισμό των ενεργειακών και οικονομικών μεγεθών και ολοκληρώνεται με τη σύνθεση και εξαγωγή των τελικών ενημερωτικών σημειωμάτων. Η αρχιτεκτονική της ροής παραμένει high-level, διακριτή και επαναλήψιμη, ώστε να υποστηρίζει σταθερά αποτελέσματα σε κάθε μηνιαίο κύκλο.
